...
**Scanner:** `~/.opencode/skills/CORE/Tools/SecretScan.ts`
...
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts

# Scan specific directory
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts /path/to/project

# Verbose output (show redacted secrets)
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts /path/to/project --verbose

# JSON output for parsing
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts /path/to/project --json

# Verify if credentials are active
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts /path/to/project --verify
```
...
```bash
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts ~/.opencode --verbose
```
...
```bash
bun ~/.opencode/skills/CORE/Tools/SecretScan.ts ~/Projects/PAI --verbose
```
