...
```bash
mkdir -p ~/.opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/SkillName
```
...
```bash
mkdir -p ~/.opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/Art
```
...
See: `~/.opencode/skills/PAI/SYSTEM/SKILLSYSTEM.md` (Skill Customization System section)
