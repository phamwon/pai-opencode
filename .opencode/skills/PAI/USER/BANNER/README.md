...
bun ~/.opencode/skills/PAI/Tools/Banner.ts

# Display specific design
bun ~/.opencode/skills/PAI/Tools/Banner.ts --design=electric

# Preview all designs
bun ~/.opencode/skills/PAI/Tools/Banner.ts --test
```
...
- **Files** - User files in skills/PAI/USER/
