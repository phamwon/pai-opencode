 ...
 *
 * Usage:
 *   bun ~/.opencode/skills/PAI/Tools/SecretScan.ts <directory>
 *   bun ~/.opencode/skills/PAI/Tools/SecretScan.ts . --verbose
 *   bun ~/.opencode/skills/PAI/Tools/SecretScan.ts . --verify
 *
