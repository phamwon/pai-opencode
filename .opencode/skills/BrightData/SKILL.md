...
`~/.opencode/skills/PAI/USER/SKILLCUSTOMIZATIONS/BrightData/`
...
- `~/.opencode/skills/PAI/SkillSystem.md` - Canonical structure guide
- `~/.opencode/skills/PAI/CONSTITUTION.md` - Overall PAI philosophy
