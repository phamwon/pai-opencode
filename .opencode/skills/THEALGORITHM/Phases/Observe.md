...
bun run ~/.opencode/skills/THEALGORITHM/Tools/ISCManager.ts create --request "Add logout button"
...
```bash
bun run ~/.opencode/skills/THEALGORITHM/Tools/ISCManager.ts interview -r "your request"
```
