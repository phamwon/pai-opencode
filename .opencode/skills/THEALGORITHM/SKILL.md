...
`~/.opencode/skills/CORE/USER/SKILLCUSTOMIZATIONS/THEALGORITHM/`
...
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts start THOROUGH -r "your request"

# Transition phases (updates display + voice announcement)
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts phase THINK
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts phase EXECUTE

# Show current status anytime
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts show

# Show just the effort banner
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts effort DETERMINED
```
...
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts start STANDARD -r "your request"

# 2. CLASSIFY EFFORT (if not using display start)
bun run ~/.opencode/skills/THEALGORITHM/Tools/EffortClassifier.ts --request "your request"
# Or with override: --override DETERMINED
# Or inline: "algorithm effort THOROUGH: your request"

# 3. LOAD CAPABILITIES for effort level
bun run ~/.opencode/skills/THEALGORITHM/Tools/CapabilityLoader.ts --effort STANDARD

# 4. CREATE ISC
bun run ~/.opencode/skills/THEALGORITHM/Tools/ISCManager.ts create --request "your request"

# 5. TRANSITION PHASES (voice + visual update)
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts phase THINK
bun run ~/.opencode/skills/THEALGORITHM/Tools/AlgorithmDisplay.ts phase PLAN
# ... continues through EXECUTE, VERIFY, LEARN

# 6. MANAGE ISC during EXECUTE
bun run ~/.opencode/skills/THEALGORITHM/Tools/ISCManager.ts capability --row 1 -c research.perplexity
bun run ~/.opencode/skills/THEALGORITHM/Tools/ISCManager.ts update --row 1 --status DONE
bun run ~/.opencode/skills/THEALGORITHM/Tools/ISCManager.ts show
```
...
```bash
bun run ~/.opencode/skills/THEALGORITHM/Tools/CapabilitySelector.ts --row "Research best practices" --effort STANDARD
