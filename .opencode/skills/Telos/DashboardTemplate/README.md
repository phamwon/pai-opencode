...
```bash
cp -r ~/.opencode/skills/telos/dashboard-template /path/to/your/project
...
- Searches `~/.opencode/skills/life/telos/` for `.md` files
- Searches `~/.opencode/skills/life/telos/data/` for `.csv` files
