...
```bash
cp -r ~/.opencode/skill/telos/dashboard-template /path/to/your/project
...
- Searches `~/.opencode/skill/life/telos/` for `.md` files
- Searches `~/.opencode/skill/life/telos/data/` for `.csv` files
