...
TELOS is {principal.name}'s life framework stored in `~/.opencode/skill/CORE/USER/TELOS/`. It contains:
...
!`head -50 ~/.opencode/skill/CORE/USER/TELOS/updates.md`

## View Specific TELOS File
!`FILE="$1"; cat ~/.opencode/skill/CORE/USER/TELOS/"$FILE"`
...
All backups are stored in: `~/.opencode/skill/CORE/USER/TELOS/Backups/`

All changes are logged in: `~/.opencode/skill/CORE/USER/TELOS/updates.md`
