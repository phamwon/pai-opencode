...
1. **Personal TELOS** - {principal.name}'s life context system (beliefs, goals, lessons, wisdom) at `~/.opencode/skill/CORE/USER/TELOS/`
...
**Full documentation:** `~/.opencode/skill/CORE/SkillNotifications.md`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.opencode/skill/CORE/USER/TELOS/` |
...
```
~/.opencode/skill/CORE/USER/TELOS/
```
...
All files located in `~/.opencode/skill/CORE/USER/TELOS/`:
...
```bash
# View specific file
read ~/.opencode/skill/CORE/USER/TELOS/GOALS.md
read ~/.opencode/skill/CORE/USER/TELOS/BELIEFS.md

# View recent updates
read ~/.opencode/skill/CORE/USER/TELOS/updates.md
```
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.opencode/skill/CORE/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `~/.opencode/skill/CORE/USER/TELOS/` (in the CORE USER directory)
