...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/AnnualReports/`
...
bun run ~/.opencode/skill/AnnualReports/Tools/UpdateSources.ts

# List all sources
bun run ~/.opencode/skill/AnnualReports/Tools/ListSources.ts [category]

# Fetch a specific report
bun run ~/.opencode/skill/AnnualReports/Tools/FetchReport.ts <vendor> <report-name>
```
