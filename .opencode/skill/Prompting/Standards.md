...
**Location:** `~/.opencode/skill/CORE/Tools/fabric/Patterns/`
...
All templates live in `~/.opencode/skill/Prompting/Templates/`:
...
**CLI Usage:**
```bash
bun ~/.opencode/skill/Prompting/Tools/RenderTemplate.ts \
