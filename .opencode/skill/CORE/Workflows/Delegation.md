...
bun run ~/.opencode/skill/Agents/Tools/AgentFactory.ts --task "..." --output prompt
...
- **Agents skill**: `~/.opencode/skill/Agents/` - Complete agent composition system
...
- Background delegation: `~/.opencode/skill/CORE/Workflows/BackgroundDelegation.md`
