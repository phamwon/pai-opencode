...
**Location:** `~/.opencode/skill/CORE/Tools/`
...
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts image.png

# Single file with output path
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts input.png output.png
...
bun ~/.opencode/skill/CORE/Tools/AddBg.ts input.png "#FFFFFF" output.png

# Add UL brand background (sepia/cream #EAE9DF)
bun ~/.opencode/skill/CORE/Tools/AddBg.ts input.png --ul-brand output.png
```
...
```bash
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts ~/Downloads/ai-generated-header.png
...
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts header.png header-transparent.png

# Then add UL brand background
bun ~/.opencode/skill/CORE/Tools/AddBg.ts header-transparent.png --ul-brand header-thumb.png
```

### Example 3: Batch Remove Backgrounds

```bash
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts diagram1.png diagram2.png diagram3.png
...
```bash
bun ~/.opencode/skill/CORE/Tools/AddBg.ts logo-transparent.png "#1a1a1a" logo-dark.png
```

### Example 5: Add White Background

```bash
bun ~/.opencode/skill/CORE/Tools/AddBg.ts chart.png "#FFFFFF" chart-white.png
```
