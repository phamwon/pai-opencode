...
2. **Update progress file**
   ```bash
   bun run ~/.opencode/skill/CORE/Tools/SessionProgress.ts next <project> "<next step 1>" "<next step 2>"
   bun run ~/.opencode/skill/CORE/Tools/SessionProgress.ts handoff <project> "<handoff notes>"
   ```

3. **Update feature registry**
   ```bash
   bun run ~/.opencode/skill/CORE/Tools/FeatureRegistry.ts list <project>
...
This comes from:
```bash
bun run ~/.opencode/skill/CORE/Tools/FeatureRegistry.ts verify <project>
```
