...
- **Architecture**: `~/.opencode/skill/CORE/SYSTEM/PAISYSTEMARCHITECTURE.md`
- **Testing Philosophy**: `~/.opencode/skill/CORE/TESTING.md`
- **Git Workflow**: `~/.opencode/skill/CORE/Workflows/Git-update-repo.md`
