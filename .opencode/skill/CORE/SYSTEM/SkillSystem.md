...
- Reference `~/.opencode/skill/CORE/USER/` for any personalization
...
- `~/.opencode/skill/CORE/USER/CONTACTS.md` - Contact information
- `~/.opencode/skill/CORE/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/SkillName`
...
**See:** `~/.opencode/skill/Science/Protocol.md` for the full protocol interface
...
**Full documentation:** `~/.opencode/skill/CORE/SYSTEM/THENOTIFICATIONSYSTEM.md`
...
Read ~/.opencode/skill/Art/Aesthetic.md
```
...
**Reference:** `~/.opencode/skill/_BLOGGING/SKILL.md`
...
**See:** `~/.opencode/skill/CORE/SYSTEM/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `~/.opencode/skill/CORE/SYSTEM/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation
 ...
 *
 * Usage:
 *   bun ~/.opencode/skill/SkillName/Tools/ToolName.ts <command> [options]
 *
 * Commands:
