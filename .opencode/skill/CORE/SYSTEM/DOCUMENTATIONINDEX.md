...
**All documentation files are in `~/.opencode/skill/CORE/` with SYSTEM/ and USER/ subdirectories. Read these files when you need deeper context.**
...
**Agent System:**
- **Agents Skill** (`~/.opencode/skill/Agents/`) - Complete agent composition system | See Agents skill for custom agent creation, traits, and voice mappings
