...
- After receiving Task result, parent calls: `bun ~/.opencode/skill/CORE/Tools/UpdateTabTitle.ts "Message"`
- This avoids transcript parsing race conditions
- See `~/.opencode/skill/CORE/Tools/UpdateTabTitle.ts` for implementation
...
**Full Documentation:** See `~/.opencode/skill/CORE/SYSTEM/TERMINALTABS.md`
...
1. **Added CAPTURE field to response format** (see `~/.opencode/skill/CORE/SKILL.md`)
...
**Tracking:** Documented in `~/.opencode/skill/CORE/SKILL.md` (History Capture System section)
...
cd ~/.opencode/skill/system/observability/dashboard/apps/server
bun run dev
...
**Check:**
1. Does `~/.opencode/skill/CORE/SKILL.md` exist?
...
- **Agent System:** `~/.opencode/skill/CORE/SYSTEM/AGENTPERSONALITIES.md`
- **History/Memory:** `~/.opencode/skill/CORE/SYSTEM/MEMORYSYSTEM.md`
...
Path: ~/.opencode/skill/CORE/Tools/Inference.ts
