...
**Location:** `~/.opencode/skill/CORE/Tools/Inference.ts`
...
bun ~/.opencode/skill/CORE/Tools/Inference.ts --level fast "System prompt" "User prompt"

# Standard (Sonnet) - balanced reasoning, typical analysis
bun ~/.opencode/skill/CORE/Tools/Inference.ts --level standard "System prompt" "User prompt"

# Smart (Opus) - deep reasoning, strategic decisions
bun ~/.opencode/skill/CORE/Tools/Inference.ts --level smart "System prompt" "User prompt"

# With JSON output
bun ~/.opencode/skill/CORE/Tools/Inference.ts --json --level fast "Return JSON" "Input"

# Custom timeout
bun ~/.opencode/skill/CORE/Tools/Inference.ts --level standard --timeout 60000 "Prompt" "Input"
```
...
**Location:** `~/.opencode/skill/CORE/Tools/RemoveBg.ts`
...
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts /path/to/image.png

# Remove background and save to different path
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts /path/to/input.png /path/to/output.png

# Process multiple images
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts image1.png image2.png image3.png
```
...
**Location:** `~/.opencode/skill/CORE/Tools/AddBg.ts`
...
bun ~/.opencode/skill/CORE/Tools/AddBg.ts /path/to/transparent.png "#EAE9DF" /path/to/output.png

# Add UL brand background color
bun ~/.opencode/skill/CORE/Tools/AddBg.ts /path/to/transparent.png --ul-brand /path/to/output.png
```
...
**Location:** `~/.opencode/skill/CORE/Tools/GetTranscript.ts`
...
bun ~/.opencode/skill/CORE/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID"

# Save transcript to file
bun ~/.opencode/skill/CORE/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=VIDEO_ID" --save /path/to/transcript.txt
```
...
**Technical Details:**
- Voice server must be running (`~/.opencode/skill/VoiceServer/`)
...
**Location:** `~/.opencode/skill/CORE/Tools/extract-transcript.py`
...
**Location:** `~/.opencode/skill/CORE/Tools/YouTubeApi.ts`
...
bun ~/.opencode/skill/CORE/Tools/YouTubeApi.ts --channel-stats

# Get video statistics
bun ~/.opencode/skill/CORE/Tools/YouTubeApi.ts --video-stats VIDEO_ID

# Get latest uploads
bun ~/.opencode/skill/CORE/Tools/YouTubeApi.ts --latest-videos
```
...
1. **Add tool file:** Place `.ts` or `.py` file directly in `~/.opencode/skill/CORE/Tools/`
...
2. **Document here:** Add section to this file with:
   - Tool location (e.g., `~/.opencode/skill/CORE/Tools/ToolName.ts`)
   - Usage examples
...
See `~/.opencode/skill/Deprecated/` for archived skill files.
