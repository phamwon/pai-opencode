 ...
 *
 * Usage:
 *   bun ~/.opencode/skill/Videotranscript/Tools/GetTranscript.ts <youtube-url>
 *   bun ~/.opencode/skill/Videotranscript/Tools/GetTranscript.ts <youtube-url> --save <output-file>
 *
 * Examples:
 *   bun ~/.opencode/skill/Videotranscript/Tools/GetTranscript.ts "https://www.youtube.com/watch?v=abc123"
 *   bun ~/.opencode/skill/Videotranscript/Tools/GetTranscript.ts "https://youtu.be/abc123" --save transcript.txt
 *
 * @author PAI System
 * @version 1.0.0
 */
