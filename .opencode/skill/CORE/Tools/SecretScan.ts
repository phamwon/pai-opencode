 ...
 *
 * Usage:
 *   bun ~/.opencode/skill/CORE/Tools/SecretScan.ts <directory>
 *   bun ~/.opencode/skill/CORE/Tools/SecretScan.ts . --verbose
 *   bun ~/.opencode/skill/CORE/Tools/SecretScan.ts . --verify
 *
 * @see ~/.opencode/skill/System/Workflows/SecretScanning.md
 */
