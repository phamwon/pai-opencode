 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '~/.opencode/skill/CORE/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun ~/.opencode/skill/CORE/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
Examples:
  bun LoadSkillConfig.ts ~/.opencode/skill/PAIUpgrade sources.json
