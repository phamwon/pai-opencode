...
```bash
mkdir -p ~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/SkillName
```
...
```bash
mkdir -p ~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/Art
```
...
See: `~/.opencode/skill/CORE/SYSTEM/SKILLSYSTEM.md` (Skill Customization System section)
