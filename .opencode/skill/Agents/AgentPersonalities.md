...
**What happens:**
1. Run `bun run ~/.opencode/skill/Agents/Tools/AgentFactory.ts` for EACH agent
...
- Trait definitions: `~/.opencode/skill/Agents/Data/Traits.yaml`
- Agent template: `~/.opencode/skill/Agents/Templates/DynamicAgent.hbs`
- Composition tool: `~/.opencode/skill/Agents/Tools/AgentFactory.ts`

---

## Named Agent Architecture

- **Location**: `~/.opencode/skill/CORE/AgentPersonalities.md` (this file)
