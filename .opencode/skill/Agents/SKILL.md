...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/Agents/`
...
```bash
# Usage examples
bun run ~/.opencode/skill/Agents/Tools/AgentFactory.ts --task "Review security architecture"
bun run ~/.opencode/skill/Agents/Tools/AgentFactory.ts --traits "legal,skeptical,meticulous"
bun run ~/.opencode/skill/Agents/Tools/AgentFactory.ts --list
```
...
**CORE Skill** (`~/.opencode/skill/CORE/`)
