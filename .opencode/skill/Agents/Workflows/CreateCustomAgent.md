...
bun run ~/.opencode/skill/Agents/Tools/AgentFactory.ts \
...
- AgentFactory tool: `~/.opencode/skill/Agents/Tools/AgentFactory.ts`
- Voice mappings: `~/.opencode/skill/Agents/AgentPersonalities.md`
