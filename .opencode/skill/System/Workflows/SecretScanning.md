...
**Scanner:** `~/.opencode/skill/CORE/Tools/SecretScan.ts`
...
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts

# Scan specific directory
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts /path/to/project

# Verbose output (show redacted secrets)
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts /path/to/project --verbose

# JSON output for parsing
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts /path/to/project --json

# Verify if credentials are active
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts /path/to/project --verify
```
...
```bash
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts ~/.opencode --verbose
```
...
```bash
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts ~/Projects/PAI --verbose
```

### 4. Full Verification (Active Credential Check)

```bash
bun ~/.opencode/skill/CORE/Tools/SecretScan.ts . --verify
```
