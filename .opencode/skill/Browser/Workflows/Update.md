...
bun run ~/.opencode/skill/Browser/Tools/Browse.ts screenshot https://example.com /tmp/test.png
bun run ~/.opencode/skill/Browser/Tools/Browse.ts verify https://example.com "body"
```
