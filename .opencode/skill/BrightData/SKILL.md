...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/BrightData/`
...
→ **READ:** ~/.opencode/skill/brightdata/Workflows/Four-tier-scrape.md
...
- `~/.opencode/skill/CORE/SkillSystem.md` - Canonical structure guide
- `~/.opencode/skill/CORE/CONSTITUTION.md` - Overall PAI philosophy
