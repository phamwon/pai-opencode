...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`
...
See `~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/` for user-specific channels.
...
**User Customizations** (`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/`):
- `EXTEND.yaml` - Extension manifest
- `youtube-channels.json` - User's personal YouTube channels

Use `bun ~/.opencode/skill/CORE/Tools/LoadSkillConfig.ts` to load configs with customizations merged.
