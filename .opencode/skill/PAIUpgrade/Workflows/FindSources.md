...
Edit `~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json`
...
cat ~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/PAIUpgrade/youtube-channels.json
