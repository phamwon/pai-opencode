...
bun run ~/.opencode/skill/THEALGORITHM/Tools/ISCManager.ts create --request "Add logout button"
...
```bash
bun run ~/.opencode/skill/THEALGORITHM/Tools/ISCManager.ts interview -r "your request"
```
