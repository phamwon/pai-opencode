...
bun run ~/.opencode/skill/THEALGORITHM/Tools/RalphLoopExecutor.ts \
...
```bash
# Check status
bun run ~/.opencode/skill/THEALGORITHM/Tools/RalphLoopExecutor.ts --status

# Cancel loop
bun run ~/.opencode/skill/THEALGORITHM/Tools/RalphLoopExecutor.ts --cancel
```
