...
```bash
# Take screenshot
bun run ~/.opencode/skill/Browser/Tools/Browse.ts screenshot <url> /tmp/verify.png

# Verify element exists
bun run ~/.opencode/skill/Browser/Tools/Browse.ts verify <url> "button.logout"
...
bun run ~/.opencode/skill/Browser/Tools/Browse.ts screenshot http://localhost:3000 /tmp/navbar.png
# Check: Is logout button visible top-right?

# 2. Functional verification
bun run ~/.opencode/skill/Browser/Tools/Browse.ts open http://localhost:3000
