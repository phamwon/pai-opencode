...
- `~/.opencode/skill/PAI/Workflows/CreatePack.md` - Uses this for icon generation
- `~/.opencode/skill/PAI/Workflows/ValidatePack.md` - Validates icon exists
- `~/.opencode/skill/PAI/Workflows/PAIIntegrityCheck.md` - Checks all icons
