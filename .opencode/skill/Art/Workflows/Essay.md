...
```bash
Read ~/.opencode/skill/Art/SKILL.md
```
...
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts /path/to/output.png

# Or batch process multiple images
bun ~/.opencode/skill/CORE/Tools/RemoveBg.ts image1.png image2.png image3.png
```

**See:** `~/.opencode/skill/Images/Workflows/BackgroundRemoval.md` for full documentation.
...
3. EMOTION → Match to register in ~/.opencode/skill/CORE/aesthetic.md
