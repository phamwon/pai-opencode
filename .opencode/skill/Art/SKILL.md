...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/Art/`
...
**Load from:** `~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
