...
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts list

# Show only paid bounty programs (not just swag)
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts list --bounty-only

# Search for programs by keyword
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts search "crypto"
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts search "finance"
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts search "cloud"

# Check if a domain has a bounty program
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts check example.com

# Update local cache from sources
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts update

# Export as JSON
bun ~/.opencode/skill/Recon/Tools/BountyPrograms.ts list --json > bounty-programs.json
```
...
Local cache stored at: `~/.opencode/skill/Recon/Data/BountyPrograms.json`
