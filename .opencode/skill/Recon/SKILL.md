...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/Recon/`
...
**Security Skills:**
- `~/.opencode/skill/OSINT/` - Entity and people reconnaissance
- `~/.opencode/skill/Webassessment/` - Web application testing
