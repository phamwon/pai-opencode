...
`~/.opencode/skill/CORE/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `~/.opencode/skill/CORE/SkillSystem.md`

**Canonical example to follow:** `~/.opencode/skill/_BLOGGING/SKILL.md`
...
**See:** `~/.opencode/skill/CORE/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `~/.opencode/skill/CORE/SkillSystem.md` (Dynamic Loading Pattern section)
